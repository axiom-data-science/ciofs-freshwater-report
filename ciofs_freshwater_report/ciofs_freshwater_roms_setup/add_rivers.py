...
import pyroms
"""
Read file `maskedge.out` and create a ROMS rivers file with coordinates and
...
Mm, Lm = dst_grd.hgrid.x_rho.shape
N, = dst_grd.vgrid.s_rho.shape
